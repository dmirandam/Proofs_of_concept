...
const file_calc_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"calc.proto\x12\x04calc\x1a\x1cgoogle/api/annotations.proto\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	"\x01a\x18\x01 \x01(\x01R\x01a\x12\f\n" +
	"\x01b\x18\x02 \x01(\x01R\x01b\"%\n" +
	"\vAddResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x01R\x06result2M\n" +
	"\n" +
	"Calculator\x12?\n" +
	"\x03Add\x12\x10.calc.AddRequest\x1a\x11.calc.AddResponse\"\x13\x82\xd3\xe4\x93\x02\r:\x01*\"\b/api/addB\x15Z\x13calc-demo/server;pbb\x06proto3"
